...
public class I222591_Q1_DOB_BY_PCIKER_COURSE_BY_COMBO extends Application{

	
	public void start(Stage primaryStage) {
        primaryStage.setTitle("Student Registration Form - Date by DatePicker, Courses by ComboBox");
        ...
        root.getChildren().addAll(
                new Label("Student Registration Form - Date by DatePicker, Courses by ComboBox"),
                nameField,
                datePicker,
                new Label("Gender"),
        ...
        submitButton.setOnAction(e-> {
        	 String errorMessage = validateForm(nameField.getText(), 
                     ...
                     addressArea.getText(),
                     courseComboBox.getValue() != null ? courseComboBox.getValue().toString() : null);
            ...
            alert.setContentText("Registration successful!\n\nName: " + nameField.getText() +
                    ...
                    "\nCourses: " + courseComboBox.getValue());
            alert.showAndWait();
        });
    ...
    public String validateForm(String name, String dob, String email, String contact, String address, String course) {
        if (name.isEmpty()) {
