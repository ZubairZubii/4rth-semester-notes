...
public class Practice {
	...
	//	 mystmt.execute( "Insert INTO Students Value"
	//	 		+ "(8, 'Uzair', 19, 'A'),(9, 'Uzair', 19, 'A'),(10, 'Uzair', 19, 'A')"
	...
	//	 );
      System.out.println("Insert successfully");
       ...
       myRs = mystmt.executeQuery("Select * from Students Where name = 'Uzair' ");
       while (myRs.next()) {
