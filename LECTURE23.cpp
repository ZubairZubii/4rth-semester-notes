...
// if virtual function placed with the base class then the display function execute for other derived function
// if virtual function placed with any derived function then display function execute for only the base class
class ZC{
protected:
string text;
float rating;
...
cout<<"yah! this is my channel"<<endl;
}
